    ...
    return (
        ...
        <section class="my-12">
            ...
            <div class="w-full shrink-0 grow-0 basis-auto text-center md:w-10/12 md:pl-6 md:text-left lg:w-9/12">
                <h1 class="mb-6 text-xl font-semibold text-rose-300">Reviews</h1>
                <h5 class="mb-6 text-xl font-semibold text-rose-300">Anna Maria Doe</h5>
                <ul class="list-inside mb-6 flex justify-center space-x-4 md:justify-start">
                <a href="#!">
                    {/* Facebook */}
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-amber-200"
                ...
                <a href="#!">
                    {/* Linkedin */}
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                    class="h-3.5 w-3.5 text-amber-200">
                    <path fill="currentColor"
                        d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
                    </svg>
                </a>
                </ul>
                <p className="w-2/4 text-rose-300">
